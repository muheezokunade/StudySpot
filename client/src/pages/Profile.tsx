                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                              ...
                              <SelectContent>
                                <SelectItem value="lagos">Lagos Study Centre</SelectItem>
                                <SelectItem value="abuja">Abuja Study Centre</SelectItem>
                                <SelectItem value="port_harcourt">Port Harcourt Study Centre</SelectItem>
